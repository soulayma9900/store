...
let AuthService = class AuthService {
    ...
    async login(request) {
        ...
        const expiresMinutes = Number(this.configService.get('JWT_EXPIRES_MINUTES') ?? 120);
        const payload = {
            sub: user.id,
    ...
    async ensureBootstrapUser(username, password, roles) {
...
exports.AuthService = AuthService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(user_schema_1.AppUser.name)),
